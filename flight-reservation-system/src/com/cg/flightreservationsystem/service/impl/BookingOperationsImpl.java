...
public class BookingOperationsImpl implements BookingOperations {
	...
	@Override
	public List<Integer> bookTicket(List<PassengerDTO> passengerList, List<Integer> seatNumbers) throws FRSException {
		for (int i = 0; i < passengerList.size(); i++) {
			...
			passengerDetailsValidator.isSeatNoValid(seatNumbers.get(i));
		...
		return passengerDao.insertPassenger(passengerList, seatNumbers);
	}
